// __tests__/components/navigation/tab-bar.test.tsx
//
// Restored in chunk 2 of visual iso V5 reconstruction (PR feat/visual-iso-v5).
// Re-points at the canonical V5 component `@/components/navigation/ratis-tab-bar`
// (named export `RatisTabBar`). Original at commit 01d62ff exercised an
// intermediate `TabBar` export that never landed — we keep the same
...
describe('RatisTabBar (V5 strict iso — navigation path)', () => {
  it('renders 5 tabs', () => {
