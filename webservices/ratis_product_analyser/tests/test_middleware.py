...
Uses raw_client (no auth bypass) — 401 responses still carry response headers.
"""
...
class TestRequestIDMiddleware:
    def test_response_contains_request_id(self, raw_client):
        ...
        resp = raw_client.get("/api/v1/product/0000000000000")
    ...
    def test_each_request_gets_unique_id(self, raw_client):
        ...
        id1 = raw_client.get("/api/v1/product/0000000000000").headers["x-request-id"]
        id2 = raw_client.get("/api/v1/product/0000000000000").headers["x-request-id"]
        assert id1 != id2
