...
class TestRequestIDMiddleware:
    ...
    def test_generated_request_id_is_valid_uuid(self, raw_client):
        ...
        # Must not raise — proves it's a valid UUID
    ...
    def test_each_request_gets_unique_id(self, raw_client):
        ...
        id1 = raw_client.get("/api/v1/admin/mystery").headers["x-request-id"]
        id2 = raw_client.get("/api/v1/admin/mystery").headers["x-request-id"]
        assert id1 != id2
