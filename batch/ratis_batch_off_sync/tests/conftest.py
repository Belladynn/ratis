...
from ratis_core.models import BatchSyncLog, Product  # noqa: F401 — registers models with Base
...
@pytest.fixture
def direct_sessionmaker(engine):
    """Plain session factory — no outer-transaction wrapping.

    Use this in dump tests where subprocess commits bypass the outer
    rollback and data must be read from the real committed state.
    """
